...
以下是一个测试用的列表环境，内容不要在意。\footnote{正文中中脚注命令测试，长脚注情况：这包括如下事实：“未经本人同意，监听、录制或转播私人性质的谈话或秘密谈话；未经本人同意，拍摄、录制或转播个人在私人场所的形象”}\cite{nonlinear1996}
\myone
这里测试列表标签功能的交叉引用格式\ref{itm:11},\ref{itm:12},\ref{itm:13},\ref{itm:14}，分别表示第一至第四层级的itemize系列的交叉引用情况\cite{cicero2}。
\begin{enumerate}
...
\begin{figure}[htbp]
	...
	\caption{第一张插图测试\protect\cite{lixiaodong1999}}\label{fig:first_image_tset}
\end{figure}
...
\section{测试\textbackslash paragraph和\textbackslash subparagraph}

我们需要将\textbackslash paragraph改造成国内常用的一种节标题样式，
\begin{verbatim}
(1) 这是我的第一个段落标题
    接下来就是内容了。
(2) 这是我的第二个段落标题
