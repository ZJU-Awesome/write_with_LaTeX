## 浙江大学软件学院研究生硕士学位论文LaTeX模板
模板改造者: 方堃 stralipch@gmail.com
模板上游作者（机械工程学院）:
...
（目前仅测试过 [TexLive 2015](https://tug.org/mactex/)）
...
（windows用户老老实实学会使用 Word 排版， 以下内容未经测试）
...
├── GBT7714-2005NLang-ZJU.bst  % 生成参考文献需要
...
│   ├── ...
│   └── ...
├── gbt7714-2005.bst   % 生成参考文献需要
├── logo
│   ├── QSY.pdf
│   └── ZJDX.pdf
├── reference_data_base % 论文引文数据库 自行维护
│   └── references.bib
